<x-app-layout>
    <div x-data="{ showModal: false, bountyId: null }">
        <div x-show="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded p-6 w-full max-w-md shadow">
                <h2 class="text-lg font-bold mb-4">Enter Your Contact Info</h2>
                <form method="POST" :action="`/bounties/${bountyId}/claim`">
                    @csrf
                    <input type="text" name="contact_info" placeholder="Discord, Email, etc."
                ...
                <article class="p-4">
                    <div class="p-4 text-white shadow rounded overflow-hidden h-full flex flex-col">
                        ...
                        <div class="flex gap-2 mt-auto">
                            ...
                            <button type="button"
                                @click="showModal = true; bountyId = {{ $bounty->id }}"
